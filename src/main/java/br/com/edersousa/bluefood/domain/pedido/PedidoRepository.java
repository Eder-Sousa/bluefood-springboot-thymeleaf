package br.com.edersousa.bluefood.domain.pedido;
...
public interface PedidoRepository extends JpaRepository<Pedido, Integer>{
	...
	public List<Object[]> findItensForFaturamento(Integer restauranteId, Integer itemCardapioId, LocalDateTime dataIncial, LocalDateTime dataFinal);
	...
	public List<Object[]> findItensForFaturamento(Integer restauranteId, LocalDateTime dataIncial, LocalDateTime dataFinal);
