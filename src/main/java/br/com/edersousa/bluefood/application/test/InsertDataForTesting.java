package br.com.edersousa.bluefood.application.test;
...
import br.com.edersousa.bluefood.domain.cliente.ClienteRepository;
import br.com.edersousa.bluefood.domain.pedido.Pedido;
import br.com.edersousa.bluefood.domain.pedido.Pedido.Status;
...
import br.com.edersousa.bluefood.util.StringUtils;
...
public class InsertDataForTesting {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		if (environment.acceptsProfiles(Profiles.of("dev")))
		{
			...
			pedido.setCliente(clientes[0]);
			pedido.setRestaurante(restaurantes[0]);
			pedido.setStatus(Status.Producao);
			pedido.setSubtotal(BigDecimal.valueOf(10));
			pedido.setTaxaEntrega(BigDecimal.valueOf(2));
			pedido.setTotal(BigDecimal.valueOf(12));
